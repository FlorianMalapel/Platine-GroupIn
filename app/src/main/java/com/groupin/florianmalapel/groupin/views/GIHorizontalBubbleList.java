...
public class GIHorizontalBubbleList extends HorizontalScrollView {
    ...
    public void createContainerScrollView(){
    ...
    public void addBubbleInViewWithPicasso(GIUser user){
        ...
        array_bubbleItems.add(new BubbleItem(imageView, user));
    }
